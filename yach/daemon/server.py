...
from yach.cmds.init_funcs import yach_init
from yach.daemon.windows_signal import kill
from yach.server.server import ssl_context_for_root, ssl_context_for_server
from yach.ssl.create_ssl import get_mozzila_ca_crt
from yach.util.yach_logging import initialize_logging
from yach.util.config import load_config
from yach.util.json_util import dict_to_json_str
from yach.util.path import mkdir
from yach.util.service_groups import validate_service
from yach.util.setproctitle import setproctitle
from yach.util.ws_message import WsRpcMessage, create_payload, format_response
...
try:
    ...
    print("Error: Make sure to run . ./activate from the project folder before starting Yach.")
    quit()
...
service_plotter = "yach plots create"
...
if getattr(sys, "frozen", False):
    name_map = {
        "yach": "yach",
        "yach_wallet": "start_wallet",
        "yach_full_node": "start_full_node",
        "yach_harvester": "start_harvester",
        "yach_farmer": "start_farmer",
        "yach_introducer": "start_introducer",
        "yach_timelord": "start_timelord",
        "yach_timelord_launcher": "timelord_launcher",
        "yach_full_node_simulator": "start_simulator",
    }
...
class WebSocketServer:
    ...
    async def exit(self) -> Dict[str, Any]:
        ...
        log.info("yach daemon exiting in 5 seconds")
