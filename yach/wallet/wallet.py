...
from yach.consensus.cost_calculator import calculate_cost_of_program, NPCResult
from yach.full_node.bundle_tools import simple_solution_generator
...
from yach.types.announcement import Announcement
...
from yach.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import (
    DEFAULT_HIDDEN_PUZZLE_HASH,
    calculate_synthetic_secret_key,
    puzzle_for_pk,
    solution_for_conditions,
)
from yach.wallet.puzzles.puzzle_utils import (
...
from yach.wallet.secret_key_store import SecretKeyStore
from yach.wallet.sign_coin_solutions import sign_coin_solutions
...
from yach.wallet.wallet_info import WalletInfo
...
class Wallet:
    ...
    async def create_spend_bundle_relative_yach(self, yach_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if yach_amount < 0:
            utxos = await self.select_coins(abs(yach_amount), exclude)
        else:
        ...
        yach_amount = spend_value + yach_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": yach_amount}]
