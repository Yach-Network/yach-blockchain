...
from yach.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_solutions:
            ...
            if r:
                ...
                if "yach" in cc_discrepancies:
                    cc_discrepancies["yach"] = cc_discrepancies["yach"] + diff
                else:
                    cc_discrepancies["yach"] = diff
