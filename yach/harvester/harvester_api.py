...
from yach.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from yach.harvester.harvester import Harvester
from yach.plotting.plot_tools import PlotInfo, parse_plot_info
from yach.protocols import harvester_protocol
from yach.protocols.farmer_protocol import FarmingInfo
from yach.protocols.protocol_message_types import ProtocolMessageTypes
from yach.server.outbound_message import make_msg
...
from yach.util.api_decorators import api_request, peer_required
from yach.util.ints import uint8, uint32, uint64
from yach.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSYachConnection
    ):
        """
