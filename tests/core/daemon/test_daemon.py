...
from yach.util.block_tools import BlockTools
from yach.util.ints import uint16
from yach.util.ws_message import create_payload
...
class TestDaemon:
    ...
    async def test_daemon_simulation(self, simulation, get_daemon):
        ...
        data = {}
        payload = create_payload("get_blockchain_state", data, service_name, "yach_full_node")
        await ws.send_str(payload)
