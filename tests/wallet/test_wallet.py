...
from yach.protocols.full_node_protocol import RespondBlock
from yach.server.server import YachServer
from yach.simulator.simulator_protocol import FarmNewBlockProtocol, ReorgProtocol
from yach.types.peer_info import PeerInfo
from yach.util.ints import uint16, uint32, uint64
...
class TestWalletSimulator:
    ...
    #         outbound: List[WSYachConnection] = wallet.server.get_outgoing_connections()
