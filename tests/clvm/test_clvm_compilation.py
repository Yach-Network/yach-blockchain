...
from yach.types.blockchain_format.program import Program, SerializedProgram

wallet_program_files = set(
    [
        "yach/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "yach/wallet/puzzles/cc.clvm",
        "yach/wallet/puzzles/yachlisp_deserialisation.clvm",
        "yach/wallet/puzzles/rom_bootstrap_generator.clvm",
        "yach/wallet/puzzles/generator_for_single_coin.clvm",
        "yach/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "yach/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "yach/wallet/puzzles/lock.inner.puzzle.clvm",
        "yach/wallet/puzzles/p2_conditions.clvm",
        "yach/wallet/puzzles/p2_delegated_conditions.clvm",
        "yach/wallet/puzzles/p2_delegated_puzzle.clvm",
        "yach/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "yach/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "yach/wallet/puzzles/p2_puzzle_hash.clvm",
        "yach/wallet/puzzles/rl_aggregation.clvm",
        "yach/wallet/puzzles/rl.clvm",
        "yach/wallet/puzzles/sha256tree_module.clvm",
        "yach/wallet/puzzles/singleton_top_layer.clvm",
        "yach/wallet/puzzles/did_innerpuz.clvm",
        "yach/wallet/puzzles/decompress_puzzle.clvm",
        "yach/wallet/puzzles/decompress_coin_solution_entry_with_prefix.clvm",
        "yach/wallet/puzzles/decompress_coin_solution_entry.clvm",
        "yach/wallet/puzzles/block_program_zero.clvm",
        "yach/wallet/puzzles/test_generator_deserialize.clvm",
        "yach/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
    ]
)

clvm_include_files = set(
    ["yach/wallet/puzzles/create-lock-puzzlehash.clvm", "yach/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "yach/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to yach/wallet/puzzles, but not added to `wallet_program_files`
        """
